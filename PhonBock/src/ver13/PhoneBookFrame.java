...
public class PhoneBookFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// ----------- 검색 -----------	
			...
			if (info == null) {
				JOptionPane.showMessageDialog(PhoneBookFrame.this, name + " 님의 정보가 없습니다.");
			} else {
				printData(info);
			}
		...
		// ----------- 수정 -----------	
			...
			if (name != null && !name.equals("")) {
				...
				PhoneInfo info = book.searchByName(name);
				if (info == null) {
					JOptionPane.showMessageDialog(PhoneBookFrame.this, name + "을 찾을 수 없습니다.");
					return;
				}
		...
		// 	----------- 삭제 -----------
			...
			if(name != null && !name.isEmpty()) {
				JOptionPane.showMessageDialog(PhoneBookFrame.this, name + "의 정보가 없습니다.", "알림", JOptionPane.OK_CANCEL_OPTION);
			...
			if (info != null) {
			    ...
			    if (delete == JOptionPane.YES_OPTION) {
			        ...
			        if (result) {
			            JOptionPane.showMessageDialog(PhoneBookFrame.this, name + "의 정보가 삭제되었습니다.", "알림", JOptionPane.OK_CANCEL_OPTION);
			        } 
			    }
			}
